...
public class DataSeeder(IServiceProvider serviceProvider) : IHostedService
{
    public async Task StartAsync(CancellationToken cancellationToken)
    {
        ...
        await PopulateAppsAsync(serviceScope, cancellationToken);
        await PopulateUsersAsync(serviceScope);
    }

    public Task StopAsync(CancellationToken cancellationToken) => Task.CompletedTask;

    static async ValueTask PopulateAppsAsync(IServiceScope serviceScope, CancellationToken cancellationToken)
    {
